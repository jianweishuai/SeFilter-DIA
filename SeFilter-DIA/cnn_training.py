...
def testing_auc(net, test_iter, loss, ctx):
    ...
    np.savetxt(os.getcwd() + '/202203/result_combined/CNN_distributuin_test.txt', predit_score, fmt='%f', delimiter=',')
    np.savetxt(os.getcwd() + '/202203/result_combined/roc_cnn_test_fpr', fpr, fmt='%f', delimiter=',')
    np.savetxt(os.getcwd() + '/202203/result_combined/roc_cnn_test_tpr', tpr, fmt='%f', delimiter=',')
...
def validating_auc(net, valid_iter, loss, ctx):
    ...
    np.savetxt(os.getcwd() + '/202203/result_combined/CNN_distributuin_valid.txt', predit_score, fmt='%f', delimiter=',')
    np.savetxt(os.getcwd() + '/202203/result_combined/roc_cnn_valid_fpr', fpr, fmt='%f', delimiter=',')
    np.savetxt(os.getcwd() + '/202203/result_combined/roc_cnn_valid_tpr', tpr, fmt='%f', delimiter=',')
...
def train_ch5(net, train_iter, valid_iter, test_iter, batch_size, trainer, ctx, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 50 == 0 or epoch == num_epochs - 1:
            ...
            net.save_parameters(os.getcwd() + "/202203/params/cnn_epoch" + str(epoch) + ".mxnet")
            np.savetxt(os.getcwd() + '/202203/result_combined/roc_cnn_train_fpr', fpr, fmt='%f', delimiter=',')
            np.savetxt(os.getcwd() + '/202203/result_combined/roc_cnn_train_tpr', tpr, fmt='%f', delimiter=',')
...
np.savetxt(os.getcwd() + '/202203/result_combined/cnn_trainingLosses.txt', train_loss, fmt='%f', delimiter=',')
np.savetxt(os.getcwd() + '/202203/result_combined/cnn_validatingLosses.txt', valid_loss, fmt='%f', delimiter=',')
 
params_file = os.getcwd() + "/202203/params/cnn_epoch100.mxnet"
